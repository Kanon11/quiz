                    ...
                    <div className="modal-body">
                                ...
                                <div className="row">
                                    <div className="col-lg-6 form-group input-group w-75 animated wow fadeInDown delay-0-1s">
                                        <div className="input-group-prepend z-Index-2">
                                            <span><img src="images/left-icon.png" alt="Left Icon" /><i className="fa fa-user-o zIndex-2 ml-n4-2 text-white"></i></span>
                                        </div>
                                        <input type="text" className="form-control textfield-rounded shadow-sm p-3 mb-4 zIndex-1" id="recipient-user" placeholder="Username" />
                                    </div>
                                    {/* Add the rest of the input fields similarly */}
                                </div>
                            </center>
                            <center>
                                <button type="button" className="gradientBtn w-75 animated wow fadeInUp delay-0-5s" onClick={handleSignUp}>Sign UP</button>
                                <p className="text-center color-blue mt-3 animated wow fadeInUp delay-0-5s pb-5">OR</p>
                            </center>
                        </form>
                        <div className="modal-footer border-0 mt-n5">
                            <center>
                                ...
                                <p className="text-center color-dark mt-3 animated wow fadeInUp delay-0-6s">Already have an account? <a href="index.html" className="color-purple">Login</a> </p>
                            </center>
                        </div>
                    </div>
                </div>
